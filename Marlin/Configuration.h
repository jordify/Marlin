...
#define STRING_CONFIG_H_AUTHOR "(Jordify, Jordi-mini-E3-V3.0)" // Who made the changes.
...
// Suppress warning regarding sensorless homing, we still use that for now
...
#define CUSTOM_MACHINE_NAME "JordiPrint"
